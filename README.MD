...
#### Download all books in chapters (PDF only)
Use this command to download books in separate chapters 
```bash
python3 main.py --dl_chapters
```
This will create a new folder for each book at the path specified by `-f`
